...
interface ProfileIncompleteReminderEmailProps {
  memberName: string
  magicUrl: string
}

export function ProfileIncompleteReminderEmail({
  memberName,
  magicUrl,
}: ProfileIncompleteReminderEmailProps) {
  return (
    <Html lang="fr">
      <Head />
      <Preview>N&apos;oubliez pas de compléter la fiche de {memberName}</Preview>
        ...
        <Container style={containerStyle}>
          ...
          <Section style={contentStyle}>
            <Heading as="h2" style={h2Style}>
              Votre fiche adhérent n&apos;est pas encore complète
            </Heading>
            <Text style={textStyle}>Bonjour,</Text>
            <Text style={textStyle}>
              La fiche de <strong>{memberName}</strong> dans l&apos;annuaire OPEN PF n&apos;a pas
              encore été complétée. Prenez quelques minutes pour la finaliser en cliquant sur le
              bouton ci-dessous.
            </Text>
            ...
            <Text style={footerTextStyle}>
              Si vous avez déjà complété votre fiche récemment, vous pouvez ignorer cet email.
            </Text>
          </Section>
        </Container>
      </Body>
